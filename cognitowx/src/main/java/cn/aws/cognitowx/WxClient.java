...
import cn.aws.cognitowx.util.HttpConnection;
...
public class WxClient {
	...
	public User getWxUser(String accessToken, String openid) {
		User user = new User();
		try {
			...
			System.out.println(TAG+" nickname="+nickname+",  headimgurl= "+ headimgurl);
