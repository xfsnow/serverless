...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/usr/local/php' '--with-openssl'"
...
#define PHP_EXTENSION_DIR       "/usr/local/php/lib/php/extensions/no-debug-non-zts-20160303"
